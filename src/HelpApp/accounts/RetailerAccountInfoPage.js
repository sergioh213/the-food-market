...
class RetailerAccountInfoPage extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        return (
            <Main className="shadow">
                <MainHeaderWrapper>
                    <MainHeader>Retailer</MainHeader><MainIconWrapper><MainIcon className="fas fa-shopping-cart"></MainIcon></MainIconWrapper>
                </MainHeaderWrapper>
                <Paragraph>
...
export default RetailerAccountInfoPage
