...
class ProducerAccountInfoPage extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        return (
            <Main className="shadow">
                <MainHeaderWrapper>
                    <MainHeader>Producer</MainHeader><MainIcon src="/content/producer-icon.png" alt=""/>
                </MainHeaderWrapper>
                <Paragraph>
...
export default ProducerAccountInfoPage
