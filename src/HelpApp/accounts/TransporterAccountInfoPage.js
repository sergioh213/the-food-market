...
class TransporterAccountInfoPage extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        return (
            <Main className="shadow">
                <MainHeaderWrapper>
                    <MainHeader>Trasnsporter</MainHeader><MainIconWrapper><MainIcon className="fas fa-truck-moving"></MainIcon></MainIconWrapper>
                </MainHeaderWrapper>
                <Paragraph>
...
export default TransporterAccountInfoPage
