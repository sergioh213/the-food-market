...
class WholesalerAccountInfoPage extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        return (
            <Main className="shadow">
                <MainHeaderWrapper>
                    <MainHeader>Wholesaler</MainHeader><MainIconWrapper><MainIcon className="fas fa-warehouse"></MainIcon></MainIconWrapper>
                </MainHeaderWrapper>
                <Paragraph>
                ...
                <Paragraph>
                    <ATags href="/help/company-type/retailer"><Bold>Retailers</Bold> <IconWrapper><Icon className="fas fa-shopping-cart"></Icon></IconWrapper> </ATags>
                     or
...
export default WholesalerAccountInfoPage
